import pandas as pd
from config import AUDIENCE_PERCENTAGE, CONTROL_GROUP_PERCENTAGE
...
df_campaign_assignments.to_csv(
    "data_generation/raw_data/campaign_assignments_raw.csv", index=False
)
